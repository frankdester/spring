...
public class Bank {
    ...
    private final ArrayList<Branch> branches;//group de branches

    public Bank(String name){ //to initialise our bank's name, permission to create our bank/ a new bank
        this.name = name;
